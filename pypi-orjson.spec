...
Source0  : https://files.pythonhosted.org/packages/81/0b/fea456a3ffe74e70ba30e01ec183a9b26bec4d497f61dcfce1b601059c60/orjson-3.10.18.tar.gz
...
%prep
%setup -q -n orjson-3.10.18
cd %{_builddir}/orjson-3.10.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746025931
...
cp %{_builddir}/orjson-%{version}/include/cargo/cc-1.2.20/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/cc-1.2.20/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/3b042d3d971924ec0296687efd50dbe08b734976 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.2.10/COPYING %{buildroot}/usr/share/package-licenses/pypi-orjson/dd445710e6e4caccc4f8a587a130eaeebe83f6f6 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.2.10/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/4c8990add9180fc59efa5b0d8faf643c9709501e || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.2.10/UNLICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ff007ce11f3ff7964f1a5b04202c4e95b5c82c85 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-static-0.2.10/COPYING %{buildroot}/usr/share/package-licenses/pypi-orjson/dd445710e6e4caccc4f8a587a130eaeebe83f6f6 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-static-0.2.10/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/4c8990add9180fc59efa5b0d8faf643c9709501e || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-static-0.2.10/UNLICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ff007ce11f3ff7964f1a5b04202c4e95b5c82c85 || :
cp %{_builddir}/orjson-%{version}/include/cargo/libc-0.2.172/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/libc-0.2.172/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/36d69bcb88153a640740000efe933b009420ce7e || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/smallvec-1.15.0/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/smallvec-1.15.0/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/c61640f6c218caf86d1b8072e09668a8362dba04 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/syn-2.0.101/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/syn-2.0.101/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
