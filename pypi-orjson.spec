...
Source0  : https://files.pythonhosted.org/packages/29/87/03ababa86d984952304ac8ce9fbd3a317afb4a225b9a81f9b606ac60c873/orjson-3.11.0.tar.gz
...
%prep
%setup -q -n orjson-3.11.0
cd %{_builddir}/orjson-3.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752602988
...
cp %{_builddir}/orjson-%{version}/include/cargo/bytecount-0.6.9/LICENSE.Apache2 %{buildroot}/usr/share/package-licenses/pypi-orjson/92170cdc034b2ff819323ff670d3b7266c8bffcd || :
cp %{_builddir}/orjson-%{version}/include/cargo/bytecount-0.6.9/LICENSE.MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/9ec2af04328d0eb6ec89ca6d75156ffc7aecf869 || :
cp %{_builddir}/orjson-%{version}/include/cargo/cc-1.2.29/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/cc-1.2.29/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/3b042d3d971924ec0296687efd50dbe08b734976 || :
cp %{_builddir}/orjson-%{version}/include/cargo/cfg-if-1.0.1/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/cfg-if-1.0.1/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/3b042d3d971924ec0296687efd50dbe08b734976 || :
cp %{_builddir}/orjson-%{version}/include/cargo/crunchy-0.2.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ef9d72cbd46e61ffd8d8a6f906ff553eb5f6233c || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/half-2.6.0/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33 || :
cp %{_builddir}/orjson-%{version}/include/cargo/half-2.6.0/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/218fc8c15534e8840cbff5801582c450c97869ab || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.2.15/COPYING %{buildroot}/usr/share/package-licenses/pypi-orjson/dd445710e6e4caccc4f8a587a130eaeebe83f6f6 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.2.15/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/4c8990add9180fc59efa5b0d8faf643c9709501e || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.2.15/UNLICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ff007ce11f3ff7964f1a5b04202c4e95b5c82c85 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-static-0.2.15/COPYING %{buildroot}/usr/share/package-licenses/pypi-orjson/dd445710e6e4caccc4f8a587a130eaeebe83f6f6 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-static-0.2.15/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/4c8990add9180fc59efa5b0d8faf643c9709501e || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-static-0.2.15/UNLICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ff007ce11f3ff7964f1a5b04202c4e95b5c82c85 || :
cp %{_builddir}/orjson-%{version}/include/cargo/libc-0.2.174/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/libc-0.2.174/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/36d69bcb88153a640740000efe933b009420ce7e || :
cp %{_builddir}/orjson-%{version}/include/cargo/memchr-2.7.5/COPYING %{buildroot}/usr/share/package-licenses/pypi-orjson/dd445710e6e4caccc4f8a587a130eaeebe83f6f6 || :
cp %{_builddir}/orjson-%{version}/include/cargo/memchr-2.7.5/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/4c8990add9180fc59efa5b0d8faf643c9709501e || :
cp %{_builddir}/orjson-%{version}/include/cargo/memchr-2.7.5/UNLICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ff007ce11f3ff7964f1a5b04202c4e95b5c82c85 || :
cp %{_builddir}/orjson-%{version}/include/cargo/once_cell-1.21.3/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/once_cell-1.21.3/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
cp %{_builddir}/orjson-%{version}/include/cargo/portable-atomic-1.11.1/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/598f87f072f66e2269dd6919292b2934dbb20492 || :
cp %{_builddir}/orjson-%{version}/include/cargo/portable-atomic-1.11.1/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/proc-macro2-1.0.95/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/proc-macro2-1.0.95/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
cp %{_builddir}/orjson-%{version}/include/cargo/pyo3-build-config-0.25.1/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/959ce149b1615b8bff3437f59282396756987859 || :
cp %{_builddir}/orjson-%{version}/include/cargo/pyo3-ffi-0.25.1/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/959ce149b1615b8bff3437f59282396756987859 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/smallvec-1.15.1/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/smallvec-1.15.1/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/c61640f6c218caf86d1b8072e09668a8362dba04 || :
cp %{_builddir}/orjson-%{version}/include/cargo/syn-2.0.104/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/syn-2.0.104/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/uuid-1.17.0/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/orjson-%{version}/include/cargo/uuid-1.17.0/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/459ceba57b368122a3cb1fd48edea59d1363cad7 || :
