...
cp %{_builddir}/orjson-%{version}/include/cargo/compact_str-0.8.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/5c59637187123fdaf921408bc38718e196e5ee9a || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/itoa-1.0.14/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/itoa-1.0.14/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.1.21/COPYING %{buildroot}/usr/share/package-licenses/pypi-orjson/dd445710e6e4caccc4f8a587a130eaeebe83f6f6 || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.1.21/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/4c8990add9180fc59efa5b0d8faf643c9709501e || :
cp %{_builddir}/orjson-%{version}/include/cargo/jiff-0.1.21/UNLICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/ff007ce11f3ff7964f1a5b04202c4e95b5c82c85 || :
cp %{_builddir}/orjson-%{version}/include/cargo/libc-0.2.169/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/libc-0.2.169/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/36d69bcb88153a640740000efe933b009420ce7e || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/portable-atomic-1.10.0/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/598f87f072f66e2269dd6919292b2934dbb20492 || :
cp %{_builddir}/orjson-%{version}/include/cargo/portable-atomic-1.10.0/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/quote-1.0.38/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/quote-1.0.38/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
cp %{_builddir}/orjson-%{version}/include/cargo/rustversion-1.0.19/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/rustversion-1.0.19/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/serde-1.0.217/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/serde-1.0.217/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
cp %{_builddir}/orjson-%{version}/include/cargo/serde_derive-1.0.217/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/serde_derive-1.0.217/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
cp %{_builddir}/orjson-%{version}/include/cargo/serde_json-1.0.135/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/serde_json-1.0.135/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/orjson-%{version}/include/cargo/syn-2.0.95/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/pypi-orjson/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/orjson-%{version}/include/cargo/syn-2.0.95/LICENSE-MIT %{buildroot}/usr/share/package-licenses/pypi-orjson/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
cp %{_builddir}/orjson-%{version}/include/cargo/target-lexicon-0.13.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-orjson/f137043e018f2024e0414a9153ea728c203ae8e5 || :
